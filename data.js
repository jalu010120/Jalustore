...
const deliveryData = [
    // Orderan Berjalan
    { slot: 1, name: 'bulilisso', order: 80, send: 60 },
    { slot: 1, name: 'Ney', order: 4340, send: 3050 },
    { slot: 1, name: 'Purili', order: 320, send: 180 },
    { slot: 1, name: 'Rain', order: 320, send: 180 },
    { slot: 1, name: 'Nayla', order: 530, send: 358 },
    { slot: 1, name: 'Aelia', order: 840, send: 280 },
    { slot: 1, name: 'Raine', order: 420, send: 280 },

    { slot: 2, name: 'Isa', order: 800, send: 40 },
    { slot: 2, name: 'Angel2', order: 600, send: 400 },
    { slot: 2, name: 'Alip', order: 320, send: 160 },
    { slot: 2, name: 'Rani', order: 320, send: 180 },
    { slot: 2, name: 'Anggi', order: 320, send: 160 }, 
    { slot: 2, name: 'Autumn', order: 850, send: 96 }, 
    { slot: 2, name: 'Amanda', order: 80, send: 40 }, 
