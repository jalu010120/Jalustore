...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 4260 },
    { slot: 1, name: 'Honey bear', order: 1400, send: 830 },
    ...
    { slot: 1, name: 'El', order: 800, send: 290 },
    { slot: 1, name: 'Asha', order: 800, send: 290 },
    { slot: 1, name: 'Onde', order: 800, send: 340 },
    { slot: 1, name: 'Nicolas', order: 1000, send: 260 },
    { slot: 1, name: 'Ian', order: 1100, send: 590 },
    { slot: 1, name: 'Amanda', order: 120, send: 60 },
    ...
    { slot: 2, name: 'Tuhin', order: 600, send: 600 },
    { slot: 2, name: 'Kyy', order: 1000, send: 600 },
    { slot: 2, name: 'Lyone', order: 1000, send: 540 },
    { slot: 2, name: 'Eca', order: 200, send: 120 },
    { slot: 2, name: 'Erin', order: 200, send: 200 },
    { slot: 2, name: 'Ready', order: 1010, send: 930 },
    { slot: 2, name: 'Van', order: 1600, send: 310 },
    { slot: 2, name: 'CurlyBee', order: 120, send: 120 },
