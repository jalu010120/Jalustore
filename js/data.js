...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 3650, statusOverride: 'fail' },
    { slot: 1, name: 'Aelia', order: 1900, send: 940 }, // Send diperbarui
    { slot: 1, name: 'Anna', order: 1080, send: 620 }, // Send diperbarui
    { slot: 1, name: 'Feng', order: 230, send: 220, statusOverride: 'fail' },
    { slot: 1, name: 'Tuna 2', order: 360, send: 200 }, // Send diperbarui
    { slot: 1, name: 'Unii', order: 400, send: 150 }, // Send diperbarui, status ❌ dihapus
    { slot: 1, name: 'archa', order: 460, send: 160 }, // Send diperbarui
    { slot: 1, name: 'Zel', order: 340, send: 60 }, // Send diperbarui
    { slot: 1, name: 'Raine', order: 340, send: 40, statusOverride: 'fail' }, // Send diperbarui, status ❌ ditambahkan

    // Slot 2
    { slot: 2, name: 'Angel2', order: 600, send: 540, statusOverride: 'fail' },
    { slot: 2, name: 'Autumn', order: 850, send: 375, statusOverride: 'fail' },
    { slot: 2, name: 'Rachel', order: 400, send: 320, statusOverride: 'fail', isSpecial: true },
    { slot: 2, name: 'Honey bear', order: 1400, send: 320, statusOverride: 'fail' },
    { slot: 2, name: 'Cem', order: 660, send: 320 }, // Send diperbarui, status ❌ dihapus
    { slot: 2, name: 'Niz', order: 720, send: 400 }, // Send diperbarui
    { slot: 2, name: 'yulii', order: 400, send: 180 }, // Send diperbarui
    { slot: 2, name: 'Ira', order: 500, send: 120 }, // Send diperbarui

    // Slot 3
    { slot: 3, name: 'Aze', order: 570, send: 520, statusOverride: 'fail' },
    { slot: 3, name: 'Lili', order: 360, send: 240, statusOverride: 'fail' }, // Send diperbarui, status ❌ ditambahkan
    { slot: 3, name: 'Onde mande', order: 800, send: 160 }, // Send diperbarui
    { slot: 3, name: 'Lia', order: 400, send: 180 }, // Send diperbarui
    { slot: 3, name: 'Cici', order: 100, send: 60 }, // Send diperbarui, status ❌ dihapus
    { slot: 3, name: 'Fia', order: 500, send: 100 }, // Order & Send diperbarui

    // Riwayat Orderan Selesai
    { slot: 'completed', name: 'Tuna', order: 360, send: 360 }, // Dipindahkan dari Slot 1
    { slot: 'completed', name: 'Asha', order: 120, send: 120 }, // Dipindahkan dari Slot 2
    { slot: 'completed', name: 'eliane', order: 120, send: 120 }, // Dipindahkan dari Slot 2
    { slot: 'completed', name: 'Louis', order: 310, send: 310 }, // Dipindahkan dari Slot 3
