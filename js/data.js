...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 3900, statusOverride: 'fail' },
    { slot: 1, name: 'Honey bear', order: 1400, send: 570, statusOverride: 'fail' },
    { slot: 1, name: 'Aelia', order: 1900, send: 1180 },
    { slot: 1, name: 'Anna', order: 1080, send: 900 },
    { slot: 1, name: 'Tuna 2', order: 360, send: 280, statusOverride: 'fail' },
    { slot: 1, name: 'Unii', order: 400, send: 400 },
    { slot: 1, name: 'Archa', order: 460, send: 440 },
    { slot: 1, name: 'Zel', order: 340, send: 320 },
    { slot: 1, name: 'Raine', order: 340, send: 300 },
    { slot: 1, name: 'Klara', order: 420, send: 240 },

    // Slot 2
    { slot: 2, name: 'Fio', order: 300, send: 200 },
    ...
    { slot: 2, name: 'Rani', order: 420, send: 200 },
    { slot: 2, name: 'Asha', order: 400, send: 240, statusOverride: 'fail' },
    { slot: 2, name: 'Eliane', order: 400, send: 260 },

    // Slot 3
    { slot: 3, name: 'Onde mande', order: 800, send: 240, statusOverride: 'fail' },
    { slot: 3, name: 'Rezz', order: 180, send: 160, statusOverride: 'fail' },
    { slot: 3, name: 'Rendy', order: 1010, send: 260 },
    { slot: 3, name: 'Saki', order: 120, send: 100, statusOverride: 'fail' },
    { slot: 3, name: 'Ian', order: 1100, send: 180 },
    { slot: 3, name: 'Lyn', order: 200, send: 100, statusOverride: 'fail' },
    { slot: 3, name: 'Fia', order: 300, send: 100 },
