...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 4260, statusOverride: 'fail' },
    { slot: 1, name: 'Honey bear', order: 1400, send: 830, statusOverride: 'fail' },
    ...
    { slot: 1, name: 'El', order: 800, send: 310 },
    { slot: 1, name: 'Asha', order: 800, send: 310 },
    { slot: 1, name: 'Onde', order: 800, send: 360 },
    { slot: 1, name: 'Nicolas', order: 1000, send: 280 },
    { slot: 1, name: 'Ian', order: 1100, send: 610 },
    { slot: 1, name: 'Amanda', order: 120, send: 60, statusOverride: 'fail' },
    ...
    { slot: 2, name: 'Kyy', order: 1000, send: 620 },
    { slot: 2, name: 'Lyone', order: 1000, send: 540, statusOverride: 'fail' },
    { slot: 2, name: 'Eca', order: 200, send: 140 },
    { slot: 2, name: 'Ready', order: 1010, send: 950 },
