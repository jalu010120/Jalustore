...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 3490, statusOverride: 'in-progress' }, // Status diubah menjadi 'in-progress'
    { slot: 1, name: 'Aelia', order: 900, send: 680 },
    { slot: 1, name: 'Rezz', order: 350, send: 180, statusOverride: 'in-progress' }, // Status diubah menjadi 'in-progress'
    { slot: 1, name: 'Aya', order: 860, send: 620 },
    { slot: 1, name: 'Anna', order: 1080, send: 340 },
    { slot: 1, name: 'Feng', order: 230, send: 80 },
    { slot: 1, name: 'Tuna', order: 360, send: 80 },
    { slot: 1, name: 'Tuna 2', order: 360, send: 80 },

    // Slot 2
    { slot: 2, name: 'Angel2', order: 600, send: 540, statusOverride: 'fail' },
    { slot: 2, name: 'Autumn', order: 850, send: 288, statusOverride: 'fail' },
    { slot: 2, name: 'Alana', order: 320, send: 260, statusOverride: 'fail' },
    { slot: 2, name: 'Ryu', order: 320, send: 220 },
    { slot: 2, name: 'Rachel', order: 400, send: 180, isSpecial: true },
    { slot: 2, name: 'Honey bear', order: 1400, send: 240 },
    { slot: 2, name: 'Cem', order: 660, send: 120, statusOverride: 'fail' },
    { slot: 2, name: 'Niz', order: 720, send: 80 },

    // Slot 3
    { slot: 3, name: 'Zee', order: 400, send: 340 },
    { slot: 3, name: 'Diyy', order: 640, send: 500 },
    { slot: 3, name: 'Aze', order: 570, send: 500 },
    { slot: 3, name: 'Idnes', order: 320, send: 275 },
    { slot: 3, name: 'Luna', order: 800, send: 758 },
    { slot: 3, name: 'Lili', order: 360, send: 40 },
    { slot: 3, name: 'Yaya', order: 200, send: 40 },
    { slot: 3, name: 'Louis', order: 310, send: 40 },
    { slot: 3, name: 'Risma', order: 120, send: 40 },
