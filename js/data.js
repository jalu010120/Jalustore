...
const deliveryData = [
    ...
    { slot: 1, name: 'Honey bear', order: 1400, send: 515 }, // Send dipindahkan dari Slot 2
    ...
    { slot: 1, name: 'Rezz', order: 180, send: 160, statusOverride: 'fail' }, // Send dipindahkan dari Slot 3

    // Slot 2
    { slot: 2, name: 'Fio', order: 300, send: 120 }, // Dipindahkan dari Slot 4
    ...
    { slot: 2, name: 'Yulii', order: 400, send: 400, statusOverride: 'done' }, // Send diperbarui
    ...
    { slot: 3, name: 'Rendy', order: 1010, send: 180, statusOverride: 'fail' },
    ...
    // Slot 4
    { slot: 4, name: 'Fio2', order: 300, send: 100, statusOverride: 'fail' },

    // Riwayat Orderan Selesai
    { slot: 'completed', name: 'Yulii', order: 400, send: 400 }, // Dipindahkan dari Slot 2
