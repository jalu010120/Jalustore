...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 3590 }, // Send diperbarui, status ❌ sebelumnya dihapus
    { slot: 1, name: 'Aelia', order: 900, send: 800 },
    { slot: 1, name: 'Rezz', order: 350, send: 280 },
    { slot: 1, name: 'Aya', order: 860, send: 760 },
    { slot: 1, name: 'Anna', order: 1080, send: 460 },
    { slot: 1, name: 'Feng', order: 230, send: 180 }, // Send diperbarui, status ❌ sebelumnya dihapus
    { slot: 1, name: 'Tuna', order: 360, send: 200 },
    { slot: 1, name: 'Tuna 2', order: 360, send: 120, statusOverride: 'fail' },

    // Slot 2
    { slot: 2, name: 'Angel2', order: 600, send: 540, statusOverride: 'fail' },
    { slot: 2, name: 'Autumn', order: 850, send: 375, statusOverride: 'fail' }, // Status ❌ ditambahkan
    { slot: 2, name: 'Ryu', order: 320, send: 300, statusOverride: 'fail' }, // Status ❌ ditambahkan
    { slot: 2, name: 'Rachel', order: 400, send: 240, statusOverride: 'fail', isSpecial: true }, // Status ❌ ditambahkan
    { slot: 2, name: 'Honey bear', order: 1400, send: 280 }, // Send diperbarui, status ❌ sebelumnya dihapus
    { slot: 2, name: 'Cem', order: 660, send: 200 }, // Send diperbarui, status ❌ sebelumnya dihapus
    ...
    { slot: 3, name: 'Luna', order: 800, send: 794, statusOverride: 'fail' }, // Status ❌ ditambahkan
    { slot: 3, name: 'Lili', order: 360, send: 120 },
    { slot: 3, name: 'Yaya', order: 200, send: 140 },
    { slot: 3, name: 'Louis', order: 310, send: 140 },
    { slot: 3, name: 'Onde mande', order: 800, send: 60, statusOverride: 'fail' }, // Status ❌ ditambahkan

    // Riwayat Orderan Selesai
    { slot: 'completed', name: 'Idnes', order: 320, send: 320 }, // Dipindahkan dari Slot 3 (Status ✅)
