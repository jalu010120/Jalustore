...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 4140, statusOverride: 'fail' },
    { slot: 1, name: 'Honey bear', order: 1400, send: 710 },
    ...
    { slot: 1, name: 'El', order: 800, send: 150 },
    { slot: 1, name: 'Asha', order: 800, send: 150 },
    { slot: 1, name: 'Onde', order: 800, send: 280, statusOverride: 'fail' },
    { slot: 1, name: 'Nicolas', order: 1000, send: 120 },
    { slot: 1, name: 'Ian', order: 1100, send: 450 },
    ...
    { slot: 2, name: 'Tuhin', order: 600, send: 460 },
    { slot: 2, name: 'Kyy', order: 1000, send: 460 },
    { slot: 2, name: 'Lyone', order: 1000, send: 460 },
    { slot: 2, name: 'Eca', order: 200, send: 80, statusOverride: 'fail' },
    { slot: 2, name: 'Erin', order: 200, send: 100, statusOverride: 'fail' },
    { slot: 2, name: 'Ready', order: 1010, send: 770 },
    { slot: 2, name: 'Van', order: 1600, send: 230, statusOverride: 'fail' },
