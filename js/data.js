...
const deliveryData = [
    ...
    { slot: 2, name: 'Tuhin', order: 600, send: 320 },
    { slot: 2, name: 'Kyy', order: 1000, send: 300 },
    { slot: 2, name: 'Lyone', order: 1000, send: 300 },
    { slot: 2, name: 'Louis', order: 310, send: 260 },
    { slot: 2, name: 'Eca', order: 200, send: 60, statusOverride: 'fail' },
    { slot: 2, name: 'Erin', order: 200, send: 80, statusOverride: 'fail' },
    { slot: 2, name: 'Ready', order: 1010, send: 610 },
    { slot: 2, name: 'Van', order: 400, send: 110 },
    { slot: 2, name: 'El', order: 800, send: 20 },
    { slot: 2, name: 'Asha', order: 800, send: 20 },
