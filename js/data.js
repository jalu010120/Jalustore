...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 4200 },
    { slot: 1, name: 'Honey bear', order: 1400, send: 770 },
    ...
    { slot: 1, name: 'El', order: 800, send: 210 },
    { slot: 1, name: 'Asha', order: 800, send: 210 },
    { slot: 1, name: 'Onde', order: 800, send: 300, statusOverride: 'fail' },
    { slot: 1, name: 'Nicolas', order: 1000, send: 180 },
    { slot: 1, name: 'Ian', order: 1100, send: 510 },
    ...
    { slot: 2, name: 'Tuhin', order: 600, send: 520 },
    { slot: 2, name: 'Kyy', order: 1000, send: 500 },
    { slot: 2, name: 'Lyone', order: 1000, send: 480, statusOverride: 'fail' },
    { slot: 2, name: 'Eca', order: 200, send: 80, statusOverride: 'fail' },
    { slot: 2, name: 'Erin', order: 200, send: 100, statusOverride: 'fail' },
    { slot: 2, name: 'Ready', order: 1010, send: 830 },
    { slot: 2, name: 'Van', order: 1600, send: 290 },
    { slot: 2, name: 'CurlyBee', order: 120, send: 20 },
