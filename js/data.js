...
const deliveryData = [
    ...
    { slot: 2, name: 'Kyy', order: 1000, send: 320 },
    { slot: 2, name: 'Lyone', order: 1000, send: 320 },
    { slot: 2, name: 'Louis', order: 310, send: 280 },
    { slot: 2, name: 'Eca', order: 200, send: 80 },
    { slot: 2, name: 'Erin', order: 200, send: 80, statusOverride: 'fail' },
    { slot: 2, name: 'Ready', order: 1010, send: 630 },
    { slot: 2, name: 'Van', order: 400, send: 130 },
    { slot: 2, name: 'El', order: 800, send: 40 },
    { slot: 2, name: 'Asha', order: 800, send: 40 },
