...
const deliveryData = [
    ...
    { slot: 1, name: 'Tuna 2', order: 360, send: 160 },
    ...
    { slot: 2, name: 'Rachel', order: 400, send: 320, isSpecial: true },
    ...
    { slot: 3, name: 'Cici', order: 100, send: 20 },
    // SLOT 4
];

/* --- Riwayat Orderan Selesai (Bisa Dilihat di sini) ---
