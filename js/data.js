...
const deliveryData = [
    ...
    { slot: 2, name: 'Tuhin', order: 600, send: 300 },
    { slot: 2, name: 'Kyy', order: 1000, send: 280 },
    { slot: 2, name: 'Lyone', order: 1000, send: 280 },
    { slot: 2, name: 'Louis', order: 310, send: 240 },
    { slot: 2, name: 'Eca', order: 200, send: 60 },
    { slot: 2, name: 'Erin', order: 200, send: 80, statusOverride: 'fail' },
    { slot: 2, name: 'Ready', order: 1010, send: 590 },
    { slot: 2, name: 'Van', order: 400, send: 100 },
