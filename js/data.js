...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 3590 },
    ...
    { slot: 1, name: 'Feng', order: 230, send: 180 },
    ...
    { slot: 2, name: 'Ryu', order: 320, send: 300, statusOverride: 'fail' },
    { slot: 2, name: 'Rachel', order: 400, send: 240, statusOverride: 'fail', isSpecial: true },
