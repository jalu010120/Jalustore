...
const deliveryData = [
    // Slot 1
    { slot: 1, name: 'Ney', order: 5000, send: 4160 },
    { slot: 1, name: 'Honey bear', order: 1400, send: 730 },
    ...
    { slot: 1, name: 'El', order: 800, send: 170 },
    { slot: 1, name: 'Asha', order: 800, send: 170 },
    { slot: 1, name: 'Onde', order: 800, send: 280, statusOverride: 'fail' },
    { slot: 1, name: 'Nicolas', order: 1000, send: 140 },
    { slot: 1, name: 'Ian', order: 1100, send: 470 },
    ...
    { slot: 2, name: 'Tuhin', order: 600, send: 480 },
    { slot: 2, name: 'Kyy', order: 1000, send: 480 },
    { slot: 2, name: 'Lyone', order: 1000, send: 460, statusOverride: 'fail' },
    { slot: 2, name: 'Eca', order: 200, send: 80, statusOverride: 'fail' },
    { slot: 2, name: 'Erin', order: 200, send: 100, statusOverride: 'fail' },
    { slot: 2, name: 'Ready', order: 1010, send: 790 },
    { slot: 2, name: 'Van', order: 1600, send: 250 },
