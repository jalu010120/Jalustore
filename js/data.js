...
const deliveryData = [
    ...
    { slot: 2, name: 'Rani', order: 420, send: 420 },
    { slot: 2, name: 'Tuhin', order: 600, send: 280 },
    { slot: 2, name: 'Kyy', order: 1000, send: 260 },
    { slot: 2, name: 'Lyone', order: 1000, send: 260 },
    { slot: 2, name: 'Louis', order: 310, send: 220 },
    { slot: 2, name: 'Eca', order: 200, send: 40, statusOverride: 'fail' },
    { slot: 2, name: 'Erin', order: 200, send: 80 },
    { slot: 2, name: 'Ready', order: 1010, send: 570 },
